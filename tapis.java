...
public class tapis {
	...
	/*show dŽroule le tapis en appliquant la mŽthode draw de chaque caree du tableau*/
	...
	/*Construit et affiche le tapis en prenant un carrŽ de base et nbr de rŽpŽtitions,*/
	...
	public static void main (String[] args){
		...
		/*On transmet cette base avec un niveau de rŽpŽtition*/
